...
export function useFormFields({ slug, translate }: Props) {
  ...
  const addProductsFields = ():IFormField[] => [
    {
      label: translate.admin.menuItems.form.name.label,
      name: "name",
      type: 'text',
      placeholder: translate.admin.menuItems.form.name.placeholder,
      autoFocus: true
    },
    {
      label: translate.admin.menuItems.form.description.label,
      name: "description",
      type: 'text',
      placeholder: translate.admin.menuItems.form.description.placeholder,
    },
    {
      label: translate.admin.menuItems.form.basePrice.label,
      name: "basePrice",
      type: 'text',
      placeholder: translate.admin.menuItems.form.basePrice.placeholder,
    },
  ]
